...
/// <summary>
/// Newtonsoft.Json converter that serializes and deserializes <see cref="BigInteger"/> values as strings.
/// </summary>
public sealed class BigIntegerConverter : JsonConverter
{
    ...
    /// <summary>
    /// Writes a <see cref="BigInteger"/> value as a string to JSON.
    /// </summary>
    /// <param name="writer">The JsonWriter to write to.</param>
    /// <param name="untypedValue">The BigInteger value to serialize.</param>
    /// <param name="serializer">The JsonSerializer.</param>
