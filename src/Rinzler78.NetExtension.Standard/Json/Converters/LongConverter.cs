...
/// <summary>
/// Newtonsoft.Json converter that serializes and deserializes <see cref="long"/> values as strings using invariant culture.
/// </summary>
public sealed class LongConverter : JsonConverter
{
    ...
    /// <summary>
    /// Writes a <see cref="long"/> value as a string to JSON.
    /// </summary>
    /// <param name="writer">The JsonWriter to write to.</param>
    /// <param name="untypedValue">The long value to serialize.</param>
    /// <param name="serializer">The JsonSerializer.</param>
