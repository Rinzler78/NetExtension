...
```csharp
bool     open     = await IPAddress.Loopback.IsPortOpened(8080u);
bool     open2    = await "192.168.1.1".IsPortOpened(80u);
...
```
Rinzler78.NetExtension/
├── Array/          # Array → byte[] helpers (Buffer.BlockCopy, CRC-ready)
...
Detailed module documentation is available in the [docs/](docs/) directory.
