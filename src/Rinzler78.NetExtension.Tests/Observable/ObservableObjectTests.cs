...
public class ObservableObjectTests
{
    ...
    public async Task SetProperty_ShouldBeThreadSafe_WhenCalledConcurrently()
    {
        ...
        testObj.Value.Should().BeGreaterThanOrEqualTo(0);
    }
    ...
    public void PropertyChanged_ShouldBeRaisedForDependentProperties()
    {
        ...
        // FullName is computed from FirstName+LastName; its change notification must also be raised
        propertyChangedEvents.Should().Contain(nameof(TestObservableObjectWithDependencies.FullName));
    }
