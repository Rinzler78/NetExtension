...
public static class CollectionHelper
{
    ...
    /// and adding items that are missing. This operation is thread-safe and atomic.
    /// </summary>
    ...
    /// </list>
    /// <para>The operation is performed within a lock on the currentItems collection for thread safety.</para>
