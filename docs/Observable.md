...
- [`[ObservableProperty]` Source Generator](#observableproperty--source-generator)
...
The `[ObservableProperty]` attribute, combined with the included Roslyn source generator, automatically generates public observable properties from private backing fields in `partial` classes.

**Requirements:**
- The class must be `partial`
- The class must inherit (directly or indirectly) from `ObservableObject`
...
**Generated code (compile-time, no runtime overhead):**

```csharp
// Auto-generated by Rinzler78.NetExtension.SourceGenerators
public string Name
{
    get => _name;
...
// Generates: public string FullName { ... }
```
