...
public static partial class StringHelper
{
    ...
    /// <summary>
    /// Performs an HTTP GET request and returns the response body as a stream. Validates the URL against SSRF attacks, supports optional timeout and cancellation.
    /// </summary>
    /// <param name="url">The absolute URL to request.</param>
    /// <param name="timeout">Optional timeout for the request.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the request.</param>
    /// <returns>A stream containing the response body.</returns>
    ...
    /// <summary>
    /// Performs an HTTP GET request and returns the response body as a string. Validates the URL against SSRF attacks, supports optional timeout and cancellation.
    /// </summary>
    /// <param name="url">The absolute URL to request.</param>
    /// <param name="timeout">Optional timeout for the request.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the request.</param>
    ...
    /// <summary>
    /// Performs an HTTP GET request and deserializes the JSON response to <typeparamref name="ReturnType"/>. Validates the URL against SSRF attacks, supports optional timeout and cancellation.
    /// </summary>
    /// <typeparam name="ReturnType">The type to deserialize the response into.</typeparam>
    /// <param name="url">The absolute URL to request.</param>
    ...
    /// <summary>
    /// Performs an HTTP GET request, deserializes the JSON response as <typeparamref name="ImplementationType"/>, and returns it as <typeparamref name="ReturnType"/>. Validates the URL against SSRF attacks, supports optional timeout and cancellation.
    /// </summary>
    /// <typeparam name="ImplementationType">The concrete type to deserialize into.</typeparam>
    /// <typeparam name="ReturnType">The return type (base type or interface).</typeparam>
    /// <param name="url">The absolute URL to request.</param>
    /// <param name="settings">Optional JSON serializer settings.</param>
    /// <param name="timeout">Optional timeout for the request.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the request.</param>
    ...
    /// <summary>
    /// Performs an HTTP POST request with the serialized object as content and returns the response as a string. Validates the URL against SSRF attacks, supports optional timeout and cancellation.
    /// </summary>
    /// <typeparam name="RequestType">The type of the request body object.</typeparam>
    /// <param name="url">The absolute URL to post to.</param>
    /// <param name="obj">The object to serialize and send as the request body.</param>
    /// <param name="timeout">Optional timeout for the request.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the request.</param>
    /// <returns>The response body as a string.</returns>
    ...
    /// <summary>
    /// Performs an HTTP POST request, deserializes the JSON response as <typeparamref name="ImplementationType"/>, and returns it as <typeparamref name="ReturnType"/>. Validates the URL against SSRF attacks, supports optional timeout and cancellation.
    /// </summary>
    /// <typeparam name="RequestType">The type of the request body object.</typeparam>
    /// <typeparam name="ImplementationType">The concrete type to deserialize into.</typeparam>
    /// <typeparam name="ReturnType">The return type (base type or interface).</typeparam>
    ...
    private static void ThrowIfBlockedAddress(IPAddress ipAddress, string paramName)
    {
        ...
        {
            // IPv4-mapped IPv6 addresses (e.g. ::ffff:127.0.0.1) must be checked as IPv4
            if (ipAddress.IsIPv4MappedToIPv6)
            {
                ThrowIfBlockedAddress(ipAddress.MapToIPv4(), paramName);
                return;
            }
